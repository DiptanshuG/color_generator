                    ...
                    <React.Fragment>
                        ...
                        <div className='flex items-center justify-center h-screen'>
                            <div className='p-4 rounded-lg shadow-md w-64 bg-white flex flex-col items-center'>
                                <h2 className='text-lg font-bold mb-4'>Premium Color Generator</h2>
                                <p className='text-center mb-4'>Generate multiple shades of Color with one click pay as you need.</p>
                                ...
                                >
                                    {isLoading ? 'Connecting…' : 'Start Generating Colors'}
                                </button>
                            </div>
                        </div>
